...
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
            <form role="form" method="post" action="/SSMDemo/equipment/${model.id}">
                <div class="form-group">
                    <label>设备ID</label>
                    <input type="text" class="form-control" name="model.code"
                           value="${model.code}" disabled="disabled">
                </div>
                <div class="form-group">
                    <label>设备描述</label>
                    <textarea class="form-control" id="desc" name="model.desc">${model.desc}</textarea>
                </div>
